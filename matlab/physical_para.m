% This file writes physical parameters into the workspace
% Originated by Yamamoto
g = 9.81;
...
%Calculate the Integral and Feedback gain
...
R = 10^3 * eye(2);
KK = lqr(A_BAR, B_BAR, Q, R);
k_f = KK(:, 1:4)					% feedback gain
k_i = KK(:, 5)						% integral gain
